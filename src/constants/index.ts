...
export const POSTGRES_DB_NAME = process.env.POSTGRES_DB_NAME || 'bridge-real-estate';
export const POSTGRES_DB_PASSWORD = process.env.POSTGRES_DB_PASSWORD || 'admin';
export const POSTGRES_DB_PORT = process.env.POSTGRES_DB_PORT || 5432;
export const POSTGRES_DB_USERNAME = process.env.POSTGRES_DB_USERNAME || 'postgres';
...
export const MESSAGES = {
  ...
  ROUTE_NOT_FOUND: "Sorry, the page/route you're looking for doesn't exist.",
